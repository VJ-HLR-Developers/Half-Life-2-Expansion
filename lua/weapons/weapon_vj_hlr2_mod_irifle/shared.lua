...
SWEP.PrintName					= "Combine iLMG 'Lawn Mower'"
SWEP.Author 					= "DrVrej"
...
SWEP.NPC_TimeUntilFireExtraTimers = {0.06} -- Extra timers, which will make the gun fire again! | The seconds are counted after the self.NPC_TimeUntilFire!
	-- Main Settings ---------------------------------------------------------------------------------------------------------------------------------------------
SWEP.ViewModel					= "models/weapons/c_irifle.mdl"
SWEP.WorldModel					= "models/vj_hlr/hl2_mod/weapons/w_combine_irifle.mdl"
SWEP.HoldType 					= "ar2"
...
SWEP.Primary.ClipSize			= 90 -- Max amount of bullets per clip
SWEP.Primary.Delay				= 0.1 -- Time until it can shoot again
SWEP.Primary.TracerType			= "AR2Tracer" -- Tracer type (Examples: AR2, laster, 9mm)
SWEP.Primary.Automatic			= true -- Is it automatic?
SWEP.Primary.Ammo				= "AR2" -- Ammo type
SWEP.Primary.Sound				= {
									"vj_hlr/hl2mod_weapon/combine_irifle/fire1.wav",
									"vj_hlr/hl2mod_weapon/combine_irifle/fire2.wav",
									"vj_hlr/hl2mod_weapon/combine_irifle/fire3.wav",
								}
SWEP.Primary.DistantSound		= {
									"vj_hlr/hl2mod_weapon/combine_irifle/wpn_combine_ar_fire_tail_01.wav",
									"vj_hlr/hl2mod_weapon/combine_irifle/wpn_combine_ar_fire_tail_02.wav",
									"vj_hlr/hl2mod_weapon/combine_irifle/wpn_combine_ar_fire_tail_03.wav",
									"vj_hlr/hl2mod_weapon/combine_irifle/wpn_combine_ar_fire_tail_04.wav",
								}
