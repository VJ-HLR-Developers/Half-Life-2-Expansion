...
ENT.Model = {"models/vj_hlr/hl2/combine_heavychopper.mdl"} -- The game will pick a random model from the table when the SNPC is spawned | Add as many as you want
...
ENT.Aerial_FlyingSpeed_Alerted = 350 -- The speed it should fly with, when it's chasing an enemy, moving away quickly, etc. | Basically running compared to ground SNPCs
