...
---------------------------------------------------------------------------------------------------------------------------------------------
net.Receive("vj_hlr2_apc_moveeffects", function()
	local ent = net.ReadEntity()
	if IsValid(ent) then
		ent.Emitter = ParticleEmitter(ent:GetPos())
		ent.MoveSmokeEffect1 = ent.Emitter:Add("particles/smokey", ent:GetPos() + ent:GetRight()*-130 + ent:GetForward()*58 + ent:GetUp()*1)
		...
		ent.MoveSmokeEffect2 = ent.Emitter:Add("particles/smokey", ent:GetPos() + ent:GetRight()*-130 + ent:GetForward()*-58 + ent:GetUp()*1)
