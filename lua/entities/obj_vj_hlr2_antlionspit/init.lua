...
function ENT:Init()
	...
	ParticleEffect("antlion_spit",self:GetPos(),Angle(0,0,0))
end
---------------------------------------------------------------------------------------------------------------------------------------------
...
function ENT:OnDestroy(data, phys)
	ParticleEffect("antlion_spit",data.HitPos,Angle(0,0,0))
	ParticleEffect("antlion_gib_01",data.HitPos,Angle(0,0,0))
end